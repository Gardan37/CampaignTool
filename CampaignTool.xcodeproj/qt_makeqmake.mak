...
QMAKE    = /usr/bin/qmake
CampaignTool.xcodeproj/project.pbxproj: CampaignTool.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o CampaignTool.xcodeproj/project.pbxproj CampaignTool.pro
